...
function usePortalDiv(id) {
  ...
  if (!rootElemRef.current) {
    const existingParent: HTMLDivElement = document.querySelector(`#${id}`) as HTMLDivElement;
...
export const Portal = forwardRef<HTMLDivElement, { id: string, [key: string]: any }>(({ id, children, ...props }, ref) => {
