...
export class BirchRoot extends BirchFolder implements IBirchRoot, IBirchFolder {
  public readonly host: IBirchCoreHost
  ...
  constructor(host: IBirchCoreHost, root: string, viewId: string) {
  ...
  public getIndexAtItemEntryID(birchId: number) {
    return this.flattenedBranch.indexOf(birchId)
  }
  ...
  public getItemEntryAtIndex(index: number) {
    const birchId = this.flattenedBranch[index]
    return BirchItem.getItemEntryById(birchId)
  }
