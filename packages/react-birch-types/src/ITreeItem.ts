import { IBirchWatcherEvent } from './IBirchWatcher'
import { IBirchCoreHost } from './IBirchCoreHost'
import type { IPathFx } from './IPathFx'
...
export enum EnumTreeItemTypeExtended {
  Item = 1,
  Folder = 2,
  NewItemPrompt,
  NewFolderPrompt,
