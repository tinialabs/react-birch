...
import { PathFx } from 'path-fx'
import { IBirchCoreHost, IBirchWatcherEvent } from '../../types/birch'
...
export interface IBirchRoot extends IBirchFolder {
   ...
   */
  forceLoadItemEntryAtPath(path: string): Promise<IBirchFolder | IBirchItem>
  /**
