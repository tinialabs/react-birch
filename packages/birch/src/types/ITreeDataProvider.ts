import { ITreeItem, EnumTreeItemType } from "../types";
...
export interface ITreeDataProvider<T> {
  ...
  id: number
   ...
   /**
     ...
     * @return `element`.
     */
    createItem?(parent: ITreeItem, label: string, pathToNewObject: string, itemType: EnumTreeItemType, content?: string): Promise<ITreeItem> 
     ...
     * @return `element`.
     */
    moveItem?(item: ITreeItem, newParent: ITreeItem, newPath: string): Promise<boolean> 
