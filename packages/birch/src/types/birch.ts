...
export interface IBirchTreeSupervisor {
	...
	notifyWillChangeParent(target: BirchItem | BirchFolder, prevParent: BirchFolder, newParent: BirchFolder)
	notifyDidChangeParent(target: BirchItem | BirchFolder, prevParent: BirchFolder, newParent: BirchFolder)
...
export type IBirchWatcherEvent = IBirchWatcherChangeEvent | IBirchWatcherAddEvent | IBirchWatcherRemoveEvent | IBirchWatcherMoveEvent | IBirchWatcheronDidChangeTreeDataEvent
